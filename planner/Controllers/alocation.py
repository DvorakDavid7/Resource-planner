...
DEPARTMENTS = "('AC', 'BI', 'BR', 'BS', 'CC', 'DE', 'DM', 'ED', 'ER', 'EX', 'IA', 'IS', 'NA', 'NL', 'OS', 'PD', 'PO', "\
              "'SA', 'SD', 'SK', 'SL', 'SU', 'TR', 'ZA')"


@allocation.route('/project_edit/<string:cid>', methods=["GET"])
@login_required
...
@allocation.route('/project_edit/get_names', methods=["GET"])
@login_required
...
@allocation.route('/project_edit/save_changes', methods=["POST"])
...
@allocation.route('/project_edit/add_worker', methods=["POST"])
